...
Spork.prefork do
  ...
  # remove the need for database-cleaner (and it's performance hit, or other work-arounds)
  ...
  RSpec.configure do |config|
    ...
    # Reset ActionMailerdeliveries before each test
    config.before(:each) { ActionMailer::Base.deliveries.clear }
    config.after(:each) { ActiveRecord::Base.logger = nil }
...
Spork.each_run do
  # Workaround for https ://github.com/guard/guard-rspec/issues/61
  ...
  # reload routes
  Nomadpm::Application.reload_routes!
